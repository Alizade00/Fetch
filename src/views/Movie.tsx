...
import { TouchableOpacity, Image, SafeAreaView, ScrollView, StyleSheet, TextInput, Text, View, Pressable } from 'react-native';
...
export const Movie = () => {
    ...
    const saveToFavorites = (item) => {
        dispatch(favoriteSlice.actions.addToFavorites(item));
    }
